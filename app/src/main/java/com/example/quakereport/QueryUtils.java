    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                currProp = features.getJSONObject(i).getJSONObject("properties");

                long time = currProp.getLong("time");

                earthquakes.add(new Earthquake( currProp.getDouble("mag"),
                                                currProp.getString("place"),
                                                currProp.getLong("time"),
                                                currProp.getString("url")));
            }
